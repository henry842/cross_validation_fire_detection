...
Model validation, classification and risk detection. This project was organized as a portfolio-ready case study: it explains the objective, the analytical path, the visual evidence and the practical interpretation behind the result.

Main objective: Evaluate fire detection performance with cross-validation to reduce overfitting and improve reliability.

**PT-BR**

Validacao de modelos, classificacao e deteccao de risco. Este projeto foi organizado como um estudo de caso pronto para portfolio: explica o objetivo, o caminho analitico, as evidencias visuais e a interpretacao pratica por tras do resultado.

Objetivo principal: Avaliar desempenho na deteccao de incendio com validacao cruzada para reduzir overfitting e aumentar confiabilidade.
